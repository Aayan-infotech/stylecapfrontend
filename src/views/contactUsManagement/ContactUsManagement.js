...
const ContactUsManagement = () => {
    ...
    const fetchContactUsData = async () => {
        try {
            const response = await axios.get("http://44.196.64.110.110:3555/api/contact/get-all-query"); // Update API URL as needed
    ...
    const handleSendReply = async (contact) => {
        try {
            const response = await axios.post("http://44.196.64.110.110:3555/api/contact/reply-query", {
                queryId: contact._id,
