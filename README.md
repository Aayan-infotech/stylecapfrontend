...
``` bash
# dev server with hot reload at http://localhost:3555
$ npm start 
```
...
Navigate to [http://localhost:3555](http://localhost:3555). The app will automatically reload if you change any of the source files.
