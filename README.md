...
``` bash
# dev server with hot reload at http://54.236.98.193:3555
$ npm start 
```
...
Navigate to [http://54.236.98.193:3555](http://54.236.98.193:3555). The app will automatically reload if you change any of the source files.
