...
``` bash
# dev server with hot reload at http://44.196.64.110:3555
$ npm start 
```
...
Navigate to [http://44.196.64.110:3555](http://44.196.64.110:3555). The app will automatically reload if you change any of the source files.
